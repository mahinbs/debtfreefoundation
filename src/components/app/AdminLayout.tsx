...
const AdminLayout = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-900 flex text-gray-100"> {/* Darker theme for Admin to distinguish */}
            ...
            <aside
                className={`
          fixed lg:static inset-y-0 left-0 z-50 w-64 overflow-y-auto bg-gray-800 border-r border-gray-700 transform transition-transform duration-200 ease-in-out
        ...
        `}
            >
                ...
                <div className="p-4 space-y-1 overflow-y-auto h-[calc(100vh-5rem)] flex flex-col">
                    ...
                    <div className="pt-4 border-t border-gray-700">
                        ...
                        <button
                            className="w-full mt-2 flex items-center px-4 py-2 text-sm text-red-400 hover:bg-red-900/20 rounded-lg transition-colors"
            ...
            {/* Main Content */}
            <div className="flex-1 flex flex-col h-screen overflow-hidden overflow-y-auto bg-gray-100 text-gray-900">
                {/* Header */}
